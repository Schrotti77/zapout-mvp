...
class BreezClient:
    ...
    async def create_invoice(
        self, amount_sats: int, description: str = "ZapOut Payment"
    ) -> Dict[str, Any]:
        """
...
class BreezSync:
    ...
    def create_invoice(
        ...
        return loop.run_until_complete(self.async_client.create_invoice(amount_sats, description))
    ...
    def check_invoice(self, payment_hash: str) -> Dict[str, Any]:
        ...
        return loop.run_until_complete(self.async_client.check_invoice(payment_hash))
    ...
    def send_payment(self, bolt11: str) -> Dict[str, Any]:
        ...
        return loop.run_until_complete(self.async_client.send_payment(bolt11))
    ...
    def get_balance(self) -> Dict[str, Any]:
        ...
        return loop.run_until_complete(self.async_client.get_balance())
...
async def handle_breez_webhook(data: dict):
    ...
    if event_type == "invoice_payment":
        ...
        return {"event": "payment_failed", "payment_hash": payment_hash}
