...
class BringinClient:
    ...
    async def create_payout(self, wallet_id: str, amount_eur: int, reference: str) -> Dict[str, Any]:
        """
...
class BringinSync:
    ...
    def add_bank_account(self, wallet_id: str, iban: str, bank_name: str) -> Dict[str, Any]:
        try:
            ...
            loop = asyncio.new_event_loop()
            asyncio.set_event_loop(loop)
        return loop.run_until_complete(self.async_client.add_bank_account(wallet_id, iban, bank_name))
    ...
    def create_payout(self, wallet_id: str, amount_eur: int, reference: str) -> Dict[str, Any]:
        try:
            ...
            loop = asyncio.new_event_loop()
            asyncio.set_event_loop(loop)
        return loop.run_until_complete(self.async_client.create_payout(wallet_id, amount_eur, reference))
