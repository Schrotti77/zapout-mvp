    ...
    try {
      ...
      if (result.success) {
        ...
        setVerifyResult({
          ...
          message: `✓ ${result.amount} sats erfolgreich eingelöst!`,
        });
        ...
        setVerifyResult({
          ...
          message: '✗ Einlösen fehlgeschlagen',
        });
      }
    } catch (e) {
    ...
    return (
      ...
      >
        ...
        {generatedToken && (
          ...
          >
            <p
              style={{ color: '#22c55e', fontSize: '14px', fontWeight: '600', marginBottom: '8px' }}
            >
              ✓ Cashu Token generiert!
            </p>
            <textarea
              readOnly
