    ...
    <div className="min-h-screen" style={{ backgroundColor: '#0a0a0a' }}>
      ...
      {showNav && (
        <nav style={{ 
          ...
          <NavButton icon="💰" label="Zahlen" active={screen === 'dashboard'} onClick={() => setScreen('dashboard')} />
          <NavButton icon="🪙" label="Cashu" active={screen === 'cashu'} onClick={() => setScreen('cashu')} />
          <NavButton icon="⚡" label="Swap" active={screen === 'swap'} onClick={() => setScreen('swap')} />
          <NavButton icon="🏪" label="Händler" active={screen === 'merchant'} onClick={() => setScreen('merchant')} />
          <NavButton icon="🛍️" label="Produkte" active={screen === 'products'} onClick={() => setScreen('products')} />
          <NavButton icon="⚙️" label="Einst." active={screen === 'settings'} onClick={() => setScreen('settings')} />
